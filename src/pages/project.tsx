    ...
    return (
        <div>
            ...
            <div className='flex justify-between max-sm:flex-col '>
                ...
                lg:p-8 lg:rounded-l-lg lg:bg-grey lg:gap-2 lg:shadow-xl'>
                    {data.filter((project) => !role || project.role === role)
                        ...
                        return (
                            <a href={project.url_github} target='_blank' rel='noreferrer' key={project.id} className='relative shadow-lg rounded'>
                            <div>
